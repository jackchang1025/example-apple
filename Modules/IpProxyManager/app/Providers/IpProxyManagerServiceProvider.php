...
namespace Modules\IpProxyManager\Providers;
...
class IpProxyManagerServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'IpProxyManager';

    protected string $nameLower = 'ipproxymanager';
